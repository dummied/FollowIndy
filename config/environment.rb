...
Rails::Initializer.run do |config|
  ...
  config.gem 'mislav-will_paginate', 
             ...
             :version => '~> 2.3.8' 
  config.gem "DanaDanger-ruby_tubesday", :version => ">= 0.2", :source => "http://gems.github.com", :lib => "ruby_tubesday"
  config.gem "yahoo_term_extraction", :lib => "yahoo_term_extractor"
  config.gem "hpricot"
  config.gem "twitter", :version => ">=0.3.7"
  config.gem "commonthread-flickr_fu", :version => ">= 0.2.2", :source => "http://gems.github.com", :lib => "flickr_fu"
  ...
  SESSION_KEY = "jwrter;wthitergo;i3u84tjo;regj85w3eghrhgnsvi34q47ytgerhgsthy" 
...
APP_ID = "YOUR_YAHOO_TERM_EXTRACTOR_KEY_HERE"

require 'action_cache_extension'
